...
# mqtt_server_ip = "192.168.0.247"  # server = rpifravan64 = lokale Server
...
def voorspel():                                         # voorspellingen over lopend kwartier + bewaren energietellers en kwartierpiek
    ...
    # global tdss, loper900, pg, pg900tot, path, limiet, alarm, kwpk, kwpkold, dagpk
...
def mqttPub(loper900, limiet, alarm, pv, pg900tot, pd, pr, pg, vl1, vl2, vl3, cl1, cl2, cl3):
    # bericht = {"tdss": tdss, "loper900": loper900, "limiet": limiet, "alarm": alarm, "pg": pg, "pv": pv, "pg900tot": pg900tot}
