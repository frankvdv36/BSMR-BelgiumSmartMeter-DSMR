...
# BSMR8 MQTT in threading. Nu is er tijd genoeg om alles optijd te laten werken.
# BSMR9 MQTT aangepast voor 2 pages met 2 slots voor MQTT 
...
def voorspel():                                         # voorspellingen over lopend kwartier + bewaren energietellers en kwartierpiek
    ...
    global dt, tdss, loper900, pg, path, kwpk, kwpkold, dagpk, limiet, alarm, pv, pg900tot, pd, pr, vl1, vl2, vl3, cl1, cl2, cl3
    if loper900 <= 898:         
        ...
        if loper900ld == 5:                             # iedere 10s wordt de info bekeken voor grafiek
            ...
            t = Thread(target = mqttPub, args=(loper900, limiet, alarm, pv, pg900tot, pd, pr, pg, vl1, vl2, vl3, cl1, cl2, cl3, edt1, edt2, ert1, ert2))
...
def mqttPub(loper900, limiet, alarm, pv, pg900tot, pd, pr, pg, vl1, vl2, vl3, cl1, cl2, cl3, edt1, edt2, ert1, ert2):
    limiet=int(limiet);alarm=int(alarm);pg900tot=int(pg900tot);pg=int(pg);pv=int(pv);vl1=int(vl1);vl2=int(vl2);vl3=int(vl3);cl1=int(cl1);cl2=int(cl2);cl3=(cl3)
    slot = 0    # page 0
    bericht = {"slot":slot,"loper900":loper900,"limiet":limiet,"alarm":alarm,"pv":pv,"pg900tot":pg900tot,"pd":pd,"pr":pr,"pg":pg}
    ...
    slot = 1    # page 1
    bericht = {"slot":slot,"edt1":edt1,"edt2":edt2,"ert1":ert1,"ert2":ert2,"pd":pd,"pr":pr,"vl1":vl1,"vl2":vl2,"vl3":vl3,"cl1":cl1,"cl2":cl2,"cl3":cl3}
    berichtjson = json.dumps(bericht)
    try: 
        client.connect (mqtt_server_ip, 1883)
        client.publish (mqtt_topic ,berichtjson)
